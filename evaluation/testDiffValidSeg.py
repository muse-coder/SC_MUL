...
####################################################
    ...
    segRange = (dataWidth-1,dataWidth+1)                   ###
####################################################
    ...
    for test in range(iterationRange):
        # num_1=random.randint(int(dataRange[1]>>12),int(dataRange[1]))
        # num_2=random.randint(int(dataRange[1]>>12),int(dataRange[1]))
        num_1=random.randint(int(16),int(dataRange[1]))
        num_2=random.randint(int(16),int(dataRange[1]))
